...
//<Image className='drop-shadow-vanguard-shadow mt-5' alt={'Vanguard Nav Logo'} src={'/images/vanguard-v.png'} width='256' height='256'></Image>
    ...
    return(
        <div className='bg-[#E2D3B4] drop-shadow-xl'>
            ...
            <div className='z-98'>
                ...
                <div className='flex flex-row justify-left align-middle drop-shadow-vanguard-shadow w-auto h-8 my-5 ml-28 p-1 bg-[#fec633]'>
                    <ul className='list-none ml-10'>
                        ...
                        <li className="text-xl font-(vanguardFont) drop-shadow-xl inline mx-5"><Link href={{pathname:'./travel'}}>Travel</Link></li>
                        <li className="text-xl font-(vanguardFont) drop-shadow-xl inline mx-5"><Link href={{pathname:'./maps'}}>Maps</Link></li>
