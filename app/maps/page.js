      ...
      <main>
        ...
        <div style={{ width: '100%', height: '100%', position: 'relative'}} className='flex flex-col justify-start my-20 z-10'>
            <div style={{ width: '60%', height: '90%', position: 'relative'}} className='border-4 border-hidden border-vanguardOrange rounded-xl ml-10 mb-10'>
                ...
                <a className="text-md text-vanguardOrange font-(vanguardFont) drop-shadow-xl m-5 underline" href="http://23.17.34.171:3876/" target="_blank">Train Map</a>
                <br></br>
                <a className="text-md text-vanguardOrange font-(vanguardFont) drop-shadow-xl m-5 underline" href="http://23.17.34.171:8123/" target="_blank">Server Map</a>
            </div>
        </div>
